...
/**
 * <p>getPassengerAttributesResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="getPassengerAttributesResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getPassengerAttributesResponse1", propOrder = {
    "_return"
})
